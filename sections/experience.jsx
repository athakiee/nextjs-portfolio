        ...
        >
          {ExperienceData.map((experience, index) =>
            experience.side === "left" ? (
              ...
              >
                <div
                  className='md:w-[45%] cursor-pointer p-3 rounded-lg border border-zinc-300 dark:border-zinc-700 shadow-zinc-300 dark:shadow-zinc-700 shadow-sm rounded'
                  onClick={() =>
                    setDesc(
                ...
                >
                  <div className='flex justify-between gap-2'>
                    ...
                    <p className='flex gap-2 items-center text-black dark:text-white'>
                  ...
                  >
                    {experience?.description.map((index, desc) => {
                     return (<li key={desc}>{index}</li>)
                  })}
                  </div>
                </div>
                <button
                ...
                >
                  {desc === experience.description ? <BsDashCircle size={22} /> : <BsPlusCircle size={22} />}
                </button>
              </div>
            ) : (
              <div
              ...
              >
                ...
                <div
                  className='md:w-[45%] cursor-pointer  transition-all duration-500 p-3 rounded-lg border border-zinc-300 dark:border-zinc-700 shadow-zinc-300 dark:shadow-zinc-700 shadow-smrounded'
                  onClick={() =>
                    setDesc(
                      desc === experience.description
                        ? ""
