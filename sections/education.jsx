      ...
      >
        ...
        >
          {EducationData.map((education) => (
            <div
              className='transition-all duration-700 flex rounded-lg border border-zinc-300 dark:border-zinc-700 shadow-md shadow-zinc-300 dark:shadow-zinc-700 rounded gap-6'
              key={education.name}
            >
              <Image
                alt={education.name}
                className='rounded-s-lg hidden md:block bg-white dark:text-white'
                height={150}
                src={education.image}
                width={150}
              />
